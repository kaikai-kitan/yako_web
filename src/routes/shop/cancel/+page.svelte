...
<div class="result-page">
	<div class="result-card">
		...
		<h1>購入をキャンセルしました</h1>
		<p class="message">カートの内容は保持されていません。<br />再度ショップからお選びください。</p>
		<a href="{base}/shop" class="btn">ショップに戻る</a>
	</div>
</div>
